          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection animation="fadeInLeft">
              ...
              <p className="text-lg text-gray-600 mb-10 leading-relaxed">
                ...
                fuqishme drejtpërdrejt nga zonat e paprekura të natyrës së Zelandës së Re dhe ta bëjmë të arritshme për
                konsumatorët që kujdesen për shëndetin në çdo vend.
              </p>
              <Button
                size="lg"
