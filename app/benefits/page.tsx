        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimatedSection className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Zbuloni pse mjalti Manuka konsiderohet si superfoodi më i fuqishëm i natyrës, i mbështetur nga kërkimi
              shkencor dhe përdorimi tradicional prej shekujsh.
            </p>
          </AnimatedSection>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection animation="fadeInLeft">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Mjalti Manuka është studiuar gjerësisht nga kërkuesit në të gjithë botën. Komponenti unik Methylglyoxal
                (MGO) është ajo që e dallon atë nga mjalti i rregullt.
              </p>
            ...
            <AnimatedSection animation="fadeInRight" delay={100}>
              <div className="relative group">
                ...
                <Image
                  src="https://images.unsplash.com/photo-1558642891-54be180ea339?q=80&w=800&auto=format&fit=crop&ixlib=rb-4.0.3"
                ...
                <CardContent className="pt-8">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      "Shpërndajeni mbi bukë ose biskota për një meze të shëndetshme",
                    ].map((tip, index) => (
                      <div key={index} className="flex items-start group">
